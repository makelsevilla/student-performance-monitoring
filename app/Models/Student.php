...
class Student extends Model
{
    ...
    {
        $student = $this;
        $sectionSubject = $student->section->sectionSubjects()->where("id", $subjectId)->first();
    ...
    public function getPerSubjectGrades()
    {
        ...
        $student = $this;
        return $subjects->map(function ($sectionSubject) use ($student) {
            return $student->getSubjectGrades($sectionSubject->id);
        });
    }
